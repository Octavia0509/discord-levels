...
exports.Rankcard = exports.leaderboard = exports.fetch = exports.removeXP = exports.addXP = void 0;
 ...
 * @returns {any}
 */
function Rankcard(message, userID) {
    if (!message)
        throw new Error("You must enter a message parameter, referring to your 'message' event");
    if (!userID)
        throw new Error("You must enter a userID parameter, corresponds to the ID of the user");
    if (typeof userID !== "string")
        throw new Error("The userID parameter must be a String");
    message.guild.members.fetch(userID).then(async (m) => {
        ...
        ;
        let attachment = new discord_js_1.MessageAttachment(image.toBuffer(), "rank.png");
